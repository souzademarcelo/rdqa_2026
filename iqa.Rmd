...
<section class="section">
  <div class="panel panel--wide">
    ...
    <h3>Avaliação integrada da qualidade da água</h3>  

    <p><strong>O Índice de Qualidade da Água (IQA)</strong> é um indicador composto por nove parâmetros físicos, químicos e biológicos: <strong>temperatura da água, pH, oxigênio dissolvido, demanda bioquímica de oxigênio, coliformes, nitrogênio total, fósforo total, sólidos totais e turbidez</strong>. Trata-se de um indicador abrangente, que representa o estado geral da qualidade da água. O mapa interativo apresenta os valores médios do IQA para a série histórica disponível entre 2010 e 2024 nos pontos de monitoramento da qualidade da água.</p>
