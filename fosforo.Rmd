...
<section class="section">
  <div class="panel panel--wide">
    ...
    <p>O mapa interativo mostra a frequência de Não-Conformidade (NC%) com as metas dos trechos monitorados. <strong>Ative a camada NC% no mapa e desative os valores médios (mg/L) para alternar entre as informações</strong>. Para trechos sem enquadramento, valem os limites da Classe 2. Médias elevadas de fósforo podem ser observadas principalmente nas grandes cidades e nos açudes do Nordeste brasileiro.</p>
...
```{=html}
    ...
    <p>A Não-Conformidade (NC%) do fósforo nos lagos é mais elevada do que a observada nos rios. Isso se deve aos limites mais restritivos definidos para o ambiente lêntico. As médias de fósforo são maiores nos corpos de água situados nas cidades quando comparadas com o meio rural.</p>
