...
```{=html}
  ...
  <div class="chart-block">
    ...
    <p>Em síntese, o desafio passou a ser <strong>implemntá-lo</strong> com governança, dados e pactuação, de modo que a qualidade observada no monitoramento alcancem as <strong>metas da gestão</strong>.</p>
      
<p>O mapa abaixo mostra as bacias estaduais e federais que já possuem algum normativo de enquadramento de enquadramento.</p>
