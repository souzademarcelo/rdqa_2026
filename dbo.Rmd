...
<p class="footnote">*Não existe limite para a classe 4 para este parâmetro.</p>
    ...
    <p>O mapa interativo mostra a frequência de Não-Conformidade (NC%) com as metas dos trechos monitorados. <strong>Ative e desative as camadas no mapapara visualizar estas informações</strong>. Para trechos sem enquadramento, valem os limites da Classe 2.</p>
    <p>Valores médios de DBO mais altos indicam pior qualidade da água. Quanto maior a NC%, maior a necessidade de ações e investimentos para alcançar os padrões de qualidade necessários. Para trechos não enquadrados, o limite da Classe 2 é usado como referência.</p>
...
```{=html}
    ...
    <p>Lagos e rios de água situados nas áreas urbanizadas apresentam médias de DBO mais altas em relação ao ambiente rural, o que aponta para a necessidade de expansão do tratamento dos efluentes produzidos nas cidades.A NC% da DBO nos lagos aumentou ao longo do período. Apesar de uma aparente redução da DBO.</p> 
```
