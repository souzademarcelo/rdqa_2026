...
<div class="grid-2">
  ...
  <p>
    ...
    <figure class="panel-figure">
      <img src="assets/img/fluxo_info.png" alt="Informações de qualidade da água para apoiar a gestão dos recursos hídricos.">
      <figcaption>
        Informações de qualidade da água para apoiar a gestão dos recursos hídricos.
      </figcaption>
    </figure>
...
od <- readRDS("data/preprocessed/od.rds")$grouped_obs
...
```{=html} 
    ...
    <p class="footnote">*O número de pontos do mapa é baseado nas medições de OD disponíveis em nossa base de dados entre 2010 e 2024.</p>
