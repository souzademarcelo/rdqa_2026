...
<div class="grid-2">
  ...
  <div class="eq-card eq-iqa">
    ...
    <p class="eq-text">
    Integra parâmetros importantes e resume tudo em uma escala de 0 a 100,           geralmente classificada como ótima, boa, regular ou ruim ou péssima.
    </p>
  </div>
  ...
  <p>
    ...
    <ul class="panel-list">
      ...
      <li>Avaliar efeitos das políticas públicas, como o <a href="enquadramento.html">enquadramento dos corpos hídricos</a>;</li>
